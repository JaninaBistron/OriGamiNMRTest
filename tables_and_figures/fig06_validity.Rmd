...
<table style="width: 100%; border-collapse: collapse; border: 1px solid grey; text-align: center;">
  ...
  <tr style="border: 1px solid grey;">
    ...
    <td>`r format(round(cor_valid_loc_r,2), nsmall=2)`
...
```
    ...
    <td>`r format(round(cor_valid_loc_c,2), nsmall=2)`
...
```
    ...
    <td>`r format(round(cor_valid_loc_c_drop,2), nsmall=2)`
...
```
  ...
  <tr style="border: 1px solid grey;">
    <td>**All Tasks**</td>
    <td>`r format(round(cor_valid_total_r,2), nsmall=2)`
...
```
    ...
    <td>`r format(round(cor_valid_total_c,2), nsmall=2)`
...
```
    ...
    <td>`r format(round(cor_valid_total_c_drop,2), nsmall=2)`
